...
class RecommenderTraining:
    ...
    def initiate_recommendation_training(self):
        try:
            ...
            pickle.dump(similarity, open(self.recommender_training_config.similarity_matrix_path, "wb"))
            ...
            return RecomenderTrainingrArtifacts(
                ...
                similarity_matrix_path=self.recommender_training_config.similarity_matrix_path,
            )
